...
write.arff(df_train, "enron_ewaldis_train.arff")
write.arff(df_test, "enron_ewaldis_test.arff")
...
write.arff(data_wide_train, "enron_baseline_train.arff")
write.arff(data_wide_test, "enron_baseline_test.arff")
